    ...
    return(
        <div className='new-post__wrapper'>
            <form onSubmit={handleSubmit}>
                ...
                <div className='item__wrapper'>
                    <div className='add-photo' onClick={handlePhotoClick}>Add Photo</div>
                </div>
                <div className='item__wrapper'>
                ...
                <div className='item__wrapper'>
                    ...
                    <div className='text-field__wrapper'>
                        <input type='number' min="0.01" step="0.01" name='pay' placeholder='10' />
                    </div>
                </div>
                <div className='item__wrapper'>
                    <InputTitle>Exeriences and Introduction:</InputTitle>
                    <div className='text-field__wrapper'>
                        <input type='text' name='experiences' placeholder='Defeated Voldemort, I use glasses and my favorite spell is Expelliarmus' />
                    </div>
                </div>
                <div className='item__wrapper'>
                    <InputTitle>Past Projects:</InputTitle>
                    <div className='text-field__wrapper'>
                        <input type='url' name='projects' placeholder='Link to Portfolio/Github/etc.' />
                    </div>
                </div>
                <div className='item__wrapper'>
                    <InputTitle>Email:</InputTitle>
                    <div className='text-field__wrapper'>
                        <input type='email' name='email' placeholder='harry.potter@hogwarts.edu' />
                    </div>
                </div>
                <div className='item__wrapper'>
